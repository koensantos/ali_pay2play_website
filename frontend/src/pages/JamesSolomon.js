    ...
    <div style={{ padding: "2rem", paddingTop: "4rem", maxWidth: 900, margin: "0 auto" }}>
      ...
      <div className="bio-container">
        <section className="bio-text">
          ...
          <h2>Background</h2>
          <p>James Solomon is the Ward E Councilmember in Jersey City, first elected in 2017. He holds a B.A. in Public Policy Analysis from Pomona College and a Master in Public Policy from Harvard Kennedy School. Before settling in Jersey City, he worked in Boston, designing policy to improve city services like pothole repair and snow removal, and later contributed to affordable housing policy in Massachusetts. He teaches as an adjunct professor at local institutions including New Jersey City University and Saint Peter's University. Solomon is a cancer survivor; diagnosed in 2015 with Hodgkin’s lymphoma, he has since recovered and says that experience reshaped his priorities in public service. His platform emphasizes affordable housing, transparency in development, strengthening tenants’ rights, combating homelessness, improving public services, and ensuring residents—not just connected interests—have a say in neighborhood-level decisions.</p>
        </section>
